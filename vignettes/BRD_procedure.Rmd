...
if(exists(wks_name)) {
  ...
  CFG_DTS[[wks_name]] <- list(
    ...
    nxp  = 0,
    rex  = "Input",
    cvt  = c(H3K27me3 = 0.5, Suz12 = 0.5),
    npc  = NA,
    knn  = c(H3K27me3 = 200, Suz12 = 300),
    cst  = c(H3K27me3 = 0.5, Suz12 = .90),
    ncl  = c(H3K27me3 =   2, Suz12 =   1)
  )
  CFG_DTS[[wks_name]]$cvt  <- CFG_DTS[[wks_name]]$cvt[antibody]
  CFG_DTS[[wks_name]]$knn  <- CFG_DTS[[wks_name]]$knn[antibody]
...
if(exists(wks_name)) {
  ...
  CFG_DTS[[wks_name]] <- list(
    ...
    npc  = NA,
    knn  = 300,
    cst  = c(H3K27me3 = .95, H3K27me2 = 0.9, H3K27me1 = 0.9),
    ncl  = c(H3K27me3 =   1, H3K27me2 =   1, H3K27me1 =   1)
  )
...
for(cmp in cfg$viz) {
  for(lbl in cmp[-1]) {
    ...
    plot_samples(
      log2(cnt), idx, col = colorize(d, mode = "rank")
    )
    plot_samples(
      log2(cnt)[brd$bg_members, ], idx,
      col = rgb(1, 1, 0), alpha = 0.05, add = T
    )
    plot_sources_2D(
