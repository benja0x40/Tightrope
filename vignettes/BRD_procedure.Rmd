...
if(exists(wks_name)) {
  ...
  CFG_DTS[[wks_name]] <- list(
    ...
    nxp  = 0,
    rex  = "Input",
    vpc  = 0.5,  # select the most discriminative components
    npc  = NA,
    knn  = 200,
    cst  = 0.5,
    ncl  = 2
...
if(exists(wks_name)) {
  ...
  CFG_DTS[[wks_name]] <- list(
    ...
    rex  = "Input",
    vpc  = 0.5,
    npc  = NA, # dimensions of variation: H3WT, K27M, EPZ = Input
    knn  = 300,
    cst  = 0.9,
    ncl  = 1
  )
...
if(exists(wks_name)) {
  ...
  CFG_DTS[[wks_name]] <- list(
    ...
    layout = matrix(1:9, 3, 3, byrow = T),
    nxp  = 0,
    # Unfortunately only H3K27me3 seems to be really negative at 7d
    rex  = c(H3K27me3 = "_7d$", H3K27me2 = "_E14$", H3K27me1 = "_7d$"),
    vpc  = 0.5, # select the most discriminative components
    npc  = NA,
    knn  = 300,
