...
E14_EPZ.me2 <- readRDS(paste0(data_path, "E14_EPZ_H3K27me2_Norm_7d.RData"))
...
for(wks_name in c("E14_EPZ.me3", "E14_EPZ.me2", "E14_EPZ.me1")) {
  ...
  crx <- wks$ann$mapped.nbr.dm3[xps]
...
ESC_BRD <- readRDS(paste0(data_path, "ESC_BRD_H3K27me3.RData"))
# -----------------------------------------------------------------------------.
# layout(matrix(1:9, 3, 3, byrow = T))
par(mar = c(6, 4, 2, 1), pch = 20, cex.main = 0.9, cex.lab = 0.8, cex.axis = 0.8)
...
idx <- as.vector(rbind(7:12, 19:24)) 
PlotParallelDensity(brd[, idx], k = 200, ylab = "log2(counts)", main = "BRD")
```
